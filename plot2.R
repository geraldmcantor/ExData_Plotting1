...
# Convert date using as.Date(). This helps to filter the data set.
...
# Plot a line graph to a png file
png("./plot2.png", width = 480, height = 480)
plot(dataSubset$Global_active_power ~ dataSubset$thedatetime, type="l", ylab="Global Active Power (kilowatts)", xlab="")
dev.off()
